...
#Error: FOREIGN KEY constraint failed --> esto es porque supervision depende de tec,maq y evsup y como esas no existen, no se pueden crear datos de supervisio
